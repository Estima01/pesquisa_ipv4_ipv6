...
def painel():
    layout = [[sg.Text('Escolha o pais: ')],
        [sg.Button('Brasil'),sg.Button('Australia'),sg.Button('EUA'),sg.Button('Quenia'),sg.Button('Sair')]]

    window = sg.Window('Painel de controle', layout)
...
while True:
    ...
    # Iterar sobre cada um dos arquivos
        for year in range(2011, 2023):
         # Ler o arquivo
            with open(f"trabalho de redes/brasil/rib{year}.txt", "r") as f:
               lines = f.readlines()
...
# Plotar o gráfico usando as listas de resultados e datas
        ...
        plt.title("Quantidade de AS por ano Brasil")
...
#grafico em barras
    ...
    # Iterar sobre cada um dos arquivos
        for year in range(2011, 2023):
         # Ler o arquivo
            with open(f"trabalho de redes/australia/rib{year}.txt", "r") as f:
               lines = f.readlines()
...
# Plotar o gráfico usando as listas de resultados e datas
        ...
        plt.title("Quantidade de AS por ano Australia")
        plt.plot(dates, ipv4_counts, label="IPV4")
        plt.plot(dates, ipv6_counts, label="IPV6")
        plt.plot(dates, both_counts, label="Ambos")
        plt.xlabel("Ano")
...
#grafico em barras
    ...
    # Iterar sobre cada um dos arquivos
        for year in range(2011, 2023):
         # Ler o arquivo
            with open(f"trabalho de redes/EUA/rib{year}.txt", "r") as f:
               lines = f.readlines()
...
# Plotar o gráfico usando as listas de resultados e datas
        ...
        plt.title("Quantidade de AS por ano EUA")
        plt.plot(dates, ipv4_counts, label="IPV4")
        plt.plot(dates, ipv6_counts, label="IPV6")
        plt.plot(dates, both_counts, label="Ambos")
        plt.xlabel("Ano")
...
#grafico em barras
    ...
    # Iterar sobre cada um dos arquivos
        for year in range(2011, 2023):
         # Ler o arquivo
            with open(f"trabalho de redes/quenia/rib{year}.txt", "r") as f:
               lines = f.readlines()
